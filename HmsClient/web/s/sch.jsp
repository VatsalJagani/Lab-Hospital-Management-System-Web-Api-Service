<%-- 
    Document   : sch
    Created on : May 1, 2017, 12:56:01 AM
    Author     : VATSAL
--%>
...
<body>
    ...
    <div class="container">
        ...
        <header class="jumbotron hero-spacer">
            ...
            <p>Schedule employee shift for different places</p>
        </header>

        <form action="${initParam['Root']}/SetSch">
            <table>
                <tr>
                    <th><input class="form-control" type="text" name="empid" placeholder="Emp-ID"></th>
                    <th><input class="form-control" type="text" name="placeid" placeholder="Place-ID"></th>
                    <th><input type="submit" value="Set"></th>
                </tr>
            </table>
        </form>
            <h4>${msg}</h4>
